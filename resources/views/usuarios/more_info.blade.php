                ...
                <form id="myForm" name="myForm" method="POST" action="{{ route('complementos.update_transportadora', $user_transportadora[0]->id) }}">
                    ...
                    <div class="col-md-12">
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="exampleInputEmail1">Tipo de Transportadora</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="exampleInputtext1">Placas de Transportadora</label>
                                    <input type="text" id="PlacasTransportadora" name="PlacasTransportadora" class="form-control" value="{{ !empty($user_transportadora[0]->PlacasTransportadora) ?  $user_transportadora[0]->PlacasTransportadora : "" }}" placeholder="Datos...">
                                </div>
