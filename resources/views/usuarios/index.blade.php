                  ...
                  @foreach($socios as $pos => $socio)
                    <tr>
                      ...
                      <button type="button" id="btnmodal" class="btn btn-success" 
                              data-toggle="modal" 
                              data-target="#modal-default{{ $socio->id }}" 
                      >
                      <i class="fas fa-edit"></i>
                      </button>

                      <button type="button" id="btnmodal" class="btn btn-danger" 
                              data-toggle="modal" 
                              data-target="#deleteConfirmationAprobado{{ $socio->id }}" 
                      >
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tableUsuarios">
                  ...
                  @foreach($usuarios as $pos => $usuario)
                    <tr>
                      ...
                      <button type="button" id="btnmodal" class="btn btn-success" 
                              data-toggle="modal" 
                              data-target="#modal-defaultUsuario{{ $usuario->id }}" 
                      >
                      <i class="fas fa-edit"></i>
                      </button>
                      ...
                      <button type="button" id="btnmodal" class="btn btn-danger" 
                              data-toggle="modal" 
                              data-target="#deleteConfirmationUsuario{{ $usuario->id }}" 
                      >
                        <i class="fas fa-trash-alt"></i>
                      </button>
                ...
                <table class="table table-striped table-bordered dt-responsive" id="tableClientes">
                  ...
                  @foreach($clientes as $pos => $cliente)
                    <tr>
                      ...
                      <button type="button" id="btnmodal" class="btn btn-success" 
                              data-toggle="modal" 
                              data-target="#modal-defaultCliente{{ $cliente->id }}" 
                      >
                      <i class="fas fa-edit"></i>
                      </button>
                      ...
                      <button type="button" id="btnmodal" class="btn btn-danger" 
                              data-toggle="modal" 
                              data-target="#deleteConfirmationCliente{{ $cliente->id }}" 
                      >
                        <i class="fas fa-trash-alt"></i>
                      </button>
